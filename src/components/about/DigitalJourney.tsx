    ...
    <>
      <div className="md:h-[60rem] w-full relative">
        ...
        <div className="flex justify-center items-center mt-12 bg-[url('/bckg-choice.png')] p-4 rounded-lg bg-no-repeat bg-cover h-full w-full">
          {/* Card */}
          <div className="bg-white rounded-lg flex flex-col justify-center gap-4 md:max-w-[94%] max-md:w-full px-4 sm:px-8 md:px-20 pt-16">
            <div className="text-center mb-8">
              <img
                ...
                className="h-[43px]"
              />
              <h2 className="text-5xl max-sm:text-3xl font-light">
